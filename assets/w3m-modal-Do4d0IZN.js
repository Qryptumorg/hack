import{d3 as v,d0 as f,d1 as a}from"./index-B45JIVxy.js";import{n as d,r as w}from"./class-map-oe5aBxsv.js";import{o as M}from"./if-defined-BL_1vHIX.js";import{w as pe,s as me,a as he,p as ve,M as g,S as ee,R as l,r as E,A as j,e as te,c as ie,C as m,b as H,d as fe,f as k,E as q,O as T,g as V,h as F,i as $,j as D,T as ge,k as be,l as ye,m as xe}from"./core-CoTyMbBZ.js";import{c as u,U as Ce}from"./index-DIVpi0DU.js";import"./vendor-railgun-uRBcfoPe.js";import"./index.es-C4cPrmZK.js";import"./async-directive-uxeiDYF0.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return he(p,()=>n(p))},subscribeKey(n,e){return me(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
