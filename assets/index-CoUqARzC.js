import{d4 as b,cT as v,cU as y,cV as x,d3 as $,d0 as g,d5 as R,dE as T,d1 as m,cZ as C}from"./index-C4pOqYWx.js";import{n as P,r as h}from"./class-map-Ds3M0WS9.js";import{c as w}from"./index-BQSWIpxL.js";const s=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),_={state:s,subscribe(t){return y(s,()=>t(s))},subscribeKey(t,e){return v(s,t,e)},showTooltip({message:t,triggerRect:e,variant:o}){s.open=!0,s.message=t,s.triggerRect=e,s.variant=o},hide(){s.open=!1,s.message="",s.triggerRect={width:0,height:0,top:0,left:0}}},a=b(_),E=$`
  :host {
    width: 100%;
    display: block;
  }
