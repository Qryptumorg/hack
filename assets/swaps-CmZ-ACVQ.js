import{cZ as P,d0 as I,cG as v,cP as h,d1 as u,cN as z,cH as R,d5 as $,cI as M,dE as K,d8 as F,d9 as Q,c_ as O,c$ as H}from"./index-C4pOqYWx.js";import{r as l,n as w}from"./class-map-Ds3M0WS9.js";import{c as A}from"./index-BQSWIpxL.js";import"./index-Cvfe_eXL.js";import"./index-CFmLfLWg.js";import"./index-CoUqARzC.js";import{S as r}from"./SwapController-BZcYJrfL.js";import"./index-CamW1YfV.js";import"./index-DKjYO23z.js";import{M as L}from"./MathUtil-BGCe3rZ3.js";import"./index-BC6f5own.js";import"./index-BZHXLr9L.js";import"./vendor-railgun-uRBcfoPe.js";import"./index-CqXDmhM1.js";import"./if-defined-BHf-TP8j.js";import"./ref-CfbYtCWH.js";import"./async-directive-BhGYRWpb.js";const q={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var D=function(e,t,o,n){var s=arguments.length,i=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,o):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,n);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(i=(s<3?a(i):s>3?a(t,o,i):a(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let S=class extends I{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;const t=this.amount&&this.price?h.multiply(this.price,this.amount)?.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};S.styles=[O,H,oe];D([w()],S.prototype,"imageSrc",void 0);D([w()],S.prototype,"name",void 0);D([w()],S.prototype,"symbol",void 0);D([w()],S.prototype,"price",void 0);D([w()],S.prototype,"amount",void 0);D([l()],S.prototype,"visible",void 0);D([l()],S.prototype,"imageError",void 0);S=D([A("wui-token-list-item")],S);const ie=P`
  :host {
    width: 100%;
  }
