import{cZ as v,c_ as I,c$ as R,d0 as f,d1 as l,cO as m,cG as d,d_ as ke,dq as S,cI as g,dE as N,d3 as Z,cH as $,dD as me,dd as b,d7 as k,d5 as h,cN as O,cJ as E,d6 as y,d8 as ze,d9 as Fe,gl as Gt,gm as he,eV as Q,eT as qi,dN as A,gn as tt,db as Ai,dP as Ki,dO as Gi,dM as Xi,dr as ft,eL as Xt,eM as Yt,go as Yi,gp as Qi,eO as jt,gq as Ji}from"./index-C4pOqYWx.js";import{n as c,r as u,a as Ii}from"./class-map-Ds3M0WS9.js";import{o as w}from"./if-defined-BHf-TP8j.js";import{c as p,U}from"./index-BQSWIpxL.js";import"./index-BZHXLr9L.js";import"./index-CqXDmhM1.js";import"./index-mRKHJd5q.js";import"./index-CFmLfLWg.js";import{W as Ea,a as Aa}from"./index-DNXfdhlM.js";import"./index-BZa0_d08.js";import"./index-CaF3mH3i.js";import"./index-Cvfe_eXL.js";import{H as Qt}from"./HelpersUtil-BIs_Bhr1.js";import{n as Zi}from"./index-Cx81zJC1.js";import{E as Y}from"./ExchangeController-CtDKINgc.js";import"./index-Dsz5lfdA.js";import"./index-C04Ed-K8.js";import"./index-CoUqARzC.js";import{M as mt}from"./MathUtil-BGCe3rZ3.js";import"./index-Bk3ZyZ9O.js";import{e as Jt,n as Zt}from"./ref-CfbYtCWH.js";import"./index-BC6f5own.js";import"./index-CamW1YfV.js";import"./index-CtJSZNd6.js";import"./index-BU50OL8N.js";import{O as bt}from"./index-nXvvPjEt.js";import{e as en}from"./index-bpNOOjK5.js";import"./index-BRzsdGde.js";import"./index-BnWo9tCw.js";import{N as tn}from"./NavigationUtil-DmfK5sOV.js";import"./index-D3-xWRnH.js";import"./vendor-railgun-uRBcfoPe.js";import"./ConstantsUtil-D2wnS2tq.js";import"./async-directive-BhGYRWpb.js";import"./browser-BytllgEy.js";const nn=v`
  :host {
    display: block;
  }
...
`;var xo=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let Kt=class extends f{constructor(){super(...arguments),this.dappImageUrl=m.state.metadata?.icons,this.walletImageUrl=d.getAccountData()?.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await jt.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){E.showError({message:"Something went wrong. We need to verify your account again."}),h.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await jt.cancelSignMessage().finally(()=>this.isCancelling=!1)}};si([u()],Tt.prototype,"isCancelling",void 0);si([u()],Tt.prototype,"isSigning",void 0);Tt=si([p("w3m-siwx-sign-message-view")],Tt);export{ci as AppKitAccountButton,ui as AppKitButton,pi as AppKitConnectButton,fi as AppKitNetworkButton,li as W3mAccountButton,be as W3mAccountSettingsView,zt as W3mAccountView,xt as W3mAllWalletsView,di as W3mButton,At as W3mChooseAccountNameView,hi as W3mConnectButton,M as W3mConnectView,It as W3mConnectWalletsView,yi as W3mConnectingExternalView,Ct as W3mConnectingMultiChainView,Et as W3mConnectingWcBasicView,we as W3mConnectingWcView,Ci as W3mDownloadsView,Ea as W3mFooter,Re as W3mFundWalletView,Si as W3mGetWalletView,wi as W3mNetworkButton,ot as W3mNetworkSwitchView,Le as W3mNetworksView,L as W3mProfileWalletsView,Aa as W3mRouter,Tt as W3mSIWXSignMessageView,_t as W3mSwitchActiveChainView,rt as W3mUnsupportedChainView,qt as W3mWalletCompatibleNetworksView,Ei as W3mWhatIsANetworkView,ki as W3mWhatIsAWalletView};
